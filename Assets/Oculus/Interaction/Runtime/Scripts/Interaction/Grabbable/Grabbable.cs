/**
* @file Grabbable.cs
* ce script est utilisé pour rendre un objet manipulable à la main en VR. Plus précisément, ce script permet 
* à l'utilisateur de saisir et de lâcher des objets dans un environnement VR.
*/
